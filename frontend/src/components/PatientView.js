...
const PatientView = ({ data }) => {
  ...
  return (
    // REMOVED "fade-in" class to stop the sliding animation
      ...
      <div className="col-lg-5 col-12 d-flex flex-column gap-3">
        ...
        <div className="card border-0 shadow-sm rounded-4 p-4 bg-white">
          ...
          <div className="progress" style={{height: '20px', borderRadius: '10px'}}>
            {/* REMOVED "progress-bar-animated" and "progress-bar-striped" */}
            <div 
...
// import React from 'react';
// import SensorMap from './SensorMap';
// import { Smile, Zap, Heart, Info, BookOpen, Sun, Moon, Coffee } from 'lucide-react';
...
//         {/* NEW: THE SUPER LAYMAN SUMMARY BOX */}
//         <div className="card border-0 shadow-sm rounded-4 p-4 bg-white border-start border-4 border-primary">
//           <div className="d-flex align-items-center gap-3 mb-3">
//             <div className="p-2 bg-light rounded-3">
//                 {wellness.icon}
...
// import React from 'react';
// import SensorMap from './SensorMap';
// import { Smile, Zap, Heart, Info } from 'lucide-react';

// const PatientView = ({ data }) => {
//   if (!data) return null;

//   const asymmetry = data.asymmetry_score || 0;
//   const dominantFreq = data.features['T7_DominantFreq'] || 0;

//   // Simple logic to translate technical scores to patient-friendly terms
//   const getMoodColor = () => asymmetry > 0 ? "#10b981" : "#f59e0b";
//   const getFocusStatus = () => dominantFreq > 12 ? "High Alert" : "Relaxed/Alpha State";

//   return (
//     <div className="row g-4 fade-in">
//       {/* 3D Brain - The centerpiece for patients */}
//       <div className="col-lg-7 col-12">
//         <SensorMap />
//       </div>
...
//         <div className="card border-0 shadow-sm rounded-4 p-4 bg-white">
//           <div className="d-flex align-items-center gap-3 mb-3">
//             <div className="p-3 rounded-circle bg-opacity-10" style={{backgroundColor: getMoodColor()}}>
//               <Smile size={32} style={{color: getMoodColor()}} />
//             </div>
//             <div>
//               <h5 className="fw-bold mb-0">Current Mindset</h5>
//               <small className="text-muted">Emotional Engagement Level</small>
//             </div>
//           </div>
//           <h2 className="fw-bold mb-1" style={{color: getMoodColor()}}>
//             {asymmetry > 0 ? "Positive / Active" : "Calm / Reflective"}
//           </h2>
//           <div className="progress mt-3" style={{height: '12px', borderRadius: '10px'}}>
//             <div 
//               className="progress-bar" 
//               style={{
//                 width: `${Math.min(100, Math.abs(asymmetry * 500))}%`, 
...
//             Your brain is showing {asymmetry > 0 ? "high engagement with external stimuli." : "a state of internal reflection."}
//           </p>
//         </div>

//         {/* Focus Card */}
//         <div className="card border-0 shadow-sm rounded-4 p-4 bg-white text-dark">
//           <div className="d-flex align-items-center gap-3 mb-3">
//             <div className="p-3 bg-primary bg-opacity-10 rounded-circle text-primary">
//               <Zap size={32} />
//             </div>
//             <div>
//               <h5 className="fw-bold mb-0">Focus Score</h5>
//               <small className="text-muted">Mental Processing Speed</small>
//             </div>
//           </div>
//           <h2 className="fw-bold mb-0 text-primary">{getFocusStatus()}</h2>
//           <div className="mt-3 p-3 bg-light rounded-3 d-flex align-items-center gap-2">
//             <Heart size={18} className="text-danger" />
//             <span className="small fw-medium">Tip: {dominantFreq > 15 ? "Time for a 2-minute breath break!" : "Great state for deep work."}</span>
//           </div>
//         </div>
//       </div>
//     </div>
